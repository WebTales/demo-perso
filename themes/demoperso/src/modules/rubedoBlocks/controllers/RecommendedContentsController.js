angular.module("rubedoBlocks").lazy.controller("RecommendedContentsController",["$scope","$location","RubedoSearchService","$route","ipCookie",
    function($scope,$location,RubedoSearchService,$route,ipCookie){
        var me = this;
        ...
        me.refreshFingerprint=function(){
            var text = "";
